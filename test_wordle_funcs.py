...
from wordle import alternative
#Test to see which letters in the English language have an alternative latin letter in
# secret word, which might contain ('á', 'é', 'í', 'ó', 'ú', 'ñ')
print(alternative('canamo'))# AN
print(alternative('abren'))# A
print(alternative('ellos'))# E
print(alternative('lemas'))# E
print(alternative('subir'))# I
print(alternative('rimar'))# I
print(alternative('torre'))# O
print(alternative('vacio'))# O
print(alternative('unido'))# U
print(alternative('aupar'))# U
print(alternative('nieve'))# N
print(alternative('novio'))# N
